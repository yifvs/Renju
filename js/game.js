...
const Game = {
    ...
    undo: function() {
        ...
        // AI模式：撤回两步（玩家+AI各一步）
        if (this.mode === 'pva') {
            if (this.moveHistory.length >= 2 && this.currentPlayer === CONFIG.PLAYER.BLACK) {
    ...
    _showBanResult: function(ban) {
        ...
        dialog.innerHTML = `
            ...
            <button onclick="Game._closeWinner(); Game.init();" style="margin-top: 10px;">再来一局</button>
        `;
